...
function HeroSection() {
  ...
  const { displayText: roleText } = useTypingEffect("Implantador de Sistemas | Desenvolvedor Jr", 50, 1500);
        ...
        >
          ...
          <div className="brutal-card p-6 max-w-2xl mb-8">
            ...
            <pre className="font-mono text-sm text-foreground/90 whitespace-pre-wrap">
              <span className="text-secondary">const</span> <span className="text-primary">professional</span> = {"{"}
              {"\n"}  <span className="text-muted-foreground">stack:</span> <span className="text-chart-3">["React", "Python", "Django", "Flask", "SQL"]</span>,
              {"\n"}  <span className="text-muted-foreground">role:</span> <span className="text-chart-3">"Implantador de Sistemas na Multimedia"</span>,
              {"\n"}  <span className="text-muted-foreground">location:</span> <span className="text-chart-3">"Fortaleza, CE"</span>,
              {"\n"}  <span className="text-muted-foreground">status:</span> <span className="text-chart-3">"Disponível para oportunidades em TI"</span>
              {"\n"}{"}"};
            </pre>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <p className="text-lg text-foreground/80 leading-relaxed">
                Sou um profissional com foco em <span className="text-primary font-semibold">implantação de sistemas</span>, 
                suporte técnico e desenvolvimento de soluções digitais. Atualmente atuo como <span className="text-primary font-semibold">Implantador de Sistemas na Multimedia</span>, 
                com atuação prática em configuração, acompanhamento e suporte em ambientes corporativos.
              </p>
               
              <p className="text-lg text-foreground/80 leading-relaxed">
                Minha trajetória combina <span className="text-secondary font-semibold">infraestrutura de T.I.</span>, 
                <span className="text-secondary font-semibold">atendimento e resolução de problemas</span> e 
                <span className="text-secondary font-semibold">desenvolvimento</span> de soluções internas, o que me permite atuar com 
                versatilidade em projetos técnicos e operacionais.
              </p>

              {/* Quick stats */}
              {/* Resumo profissional otimizado para LinkedIn / candidaturas */}
              <div className="brutal-card p-4 mb-4">
                <div className="flex items-center justify-between mb-2">
                  <div className="font-mono text-sm text-muted-foreground">Resumo Profissional</div>
                  <div className="font-mono text-xs text-secondary">Versão para LinkedIn</div>
                </div>
                <div className="text-sm text-foreground/90 mb-3">
                  Sou Implantador de Sistemas na Multimedia com experiência em implantação, configuração e suporte de soluções corporativas. Atuo na análise de requisitos, testes de implantação, treinamento de usuários e acompanhamento pós-implantação, garantindo disponibilidade e melhoria contínua dos processos.
                </div>
                <div className="flex items-center gap-3">
                  <Button className="brutal-card bg-primary text-primary-foreground hover:bg-primary/90 font-mono px-4 py-2" onClick={() => { navigator.clipboard?.writeText && navigator.clipboard.writeText("Sou Implantador de Sistemas na Multimedia com experiência em implantação, configuração e suporte de soluções corporativas. Atuo na análise de requisitos, testes de implantação, treinamento de usuários e acompanhamento pós-implantação, garantindo disponibilidade e melhoria contínua dos processos."); alert('Resumo copiado para a área de transferência'); }}>
                    Copiar para LinkedIn
                  </Button>
                  <a href="#contato" className="font-mono text-sm text-secondary underline">Editar perfil</a>
                </div>
              </div>
...
function SkillsSection() {
  ...
  const skillCategories = [
    ...
    },
    {
      ...
      skills: ["Manutenção de PCs", "Redes", "CRMs", "CIS", "CFTV", "Backup", "Implantação de Sistemas"]
    }
  ];
